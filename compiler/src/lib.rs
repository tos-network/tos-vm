...
use tos_types::{Constant, Primitive};
...
mod tests {
    ...
    use tos_types::{Primitive, Type, ValueCell};
    ...
    fn test_dangling_values() {
        ...
        assert_eq!(
            ...
            &[
                ...
                OpCode::Constant.as_byte(), 0, 0,
                // get
                OpCode::SysCall.as_byte(), 114, 0,
                // unwrap (u16 id)
                OpCode::SysCall.as_byte(), 24, 0,
                // let dummy: u64 = x.get("a").unwrap();
