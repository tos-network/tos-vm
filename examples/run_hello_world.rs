//! Simple test runner for hello-world contract
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("=== TOS VM - Hello World Test Runner ===\n");
    ...
    // 2. Load hello-world executable
    println!("2. Loading hello-world.so...");
    let elf_path = "examples/hello-world/target/tbpf-tos-tos/release/hello_world.so";
    ...
    println!("   ✓ Context created with 200,000 compute units\n");
    ...
    println!("   Compute units used: {}", 200_000 - invoke_context.get_remaining());
